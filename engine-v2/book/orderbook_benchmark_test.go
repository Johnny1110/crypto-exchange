...
func BenchmarkMakeLimitOrder(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		if _, err := ob.PlaceOrder(LIMIT, order); err != nil {
...
func BenchmarkTakeLimitOrder_FullMatch(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		_, err := ob.PlaceOrder(LIMIT, taker)
		if err != nil {
...
func BenchmarkTakeMarketOrder(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		_, err := ob.PlaceOrder(MARKET, taker)
		if err != nil {
